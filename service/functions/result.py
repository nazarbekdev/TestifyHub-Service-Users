    ...
    def pdf_create(data, language):
        ...
        for item in data['result']:
            ...
            if item[1] == 1:
                ...
                pdf.image('/Users/uzmacbook/Portfolio/CamTest-admin/media/files/correct.png', x=_b, y=ans_cor - 3, w=3, h=3)
            else:
                answ = item[0]
                pdf.text(_a, ans_cor, txt=f"{counter}.  {answ}")
                pdf.image('/Users/uzmacbook/Portfolio/CamTest-admin/media/files/wrong.png', x=_b, y=ans_cor - 3, w=3, h=3)
            ans_cor += 5
            counter += 1
        d = datetime.now().day
        h = datetime.now().hour
        ...
        final_pdf_path = os.path.join("/Users/uzmacbook/Portfolio/CamTest-admin/media/check_file/outputfile/", file_name)
